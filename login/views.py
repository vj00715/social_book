...
def signup(request):
    if request.method == "POST":
        ...
        user = User.objects.create_user(first_name=firstname,last_name=lastname,email=mail,username=uname,password=passs)
        user.save()
        print("save")
        # print(mail0,username0,password0)
        # print(cnfpassword0,fullname0,city0)
